...
class HelperState extends State<Helper> {
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text('Krishak',style: GoogleFonts.poppins(color: Colors.white,fontSize:32),)
                ],
              ),
            ),
          ),
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          Expanded(child: Text('KRISHAK has calculated and here are the results!',style: GoogleFonts.poppins(fontSize: 16,color: Colors.white),)),
                        ],
                      ),
  ...
  String getAsset(int ans) {
    if(ans==0)
      {
        return ".dart_tool/assets/detail/plant_happy.png";
      }
    else
      {
        return ".dart_tool/assets/detail/plant_sad.png";
      }
  }
