              ...
              children:[
                ...
                Padding(
                  ...
                  child: GestureDetector(
                    onTap:()=>launch('https://github.com/Ujjwal-kasera/ProjectKrishak'),
                    child: Container(
                      padding: const EdgeInsets.all(20),
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              Text('Akash Yadav',style: GoogleFonts.poppins(fontSize: 24,color: Colors.white,fontWeight: FontWeight.w600),),
                ...
                Padding(
                  padding: const EdgeInsets.all(20),
                  child: GestureDetector(
                    onTap:()=>launch('https://github.com/Ujjwal-kasera'),
                    child: Container(
                      padding: const EdgeInsets.all(20),
                      decoration: BoxDecoration(
                      ...
                      child: Row(
                        ...
                        children: [
                          Column(
                            ...
                            children: [
                              Text('Tanishq Sirvastava',style: GoogleFonts.poppins(fontSize: 24,color: Colors.white,fontWeight: FontWeight.w600),),
                ...
                Padding(
                  padding: const EdgeInsets.all(20),
                  child: GestureDetector(
                    onTap:()=>launch('https://github.com/Tanishq212/Krishak-'),
                    child: Container(
                      padding: const EdgeInsets.all(20),
                      decoration:BoxDecoration(
                        color:  Colors.green,
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Column(
                            crossAxisAlignment: CrossAxisAlignment.end,
                            children: [
                              Text('Ujjwal Kasera',style: GoogleFonts.poppins(fontSize: 24,color: Colors.white,fontWeight: FontWeight.w600),),
                      ...
                      child: Row(
                        ...
                        children: [
                          Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text('Shirshendu Lahiri',style: GoogleFonts.poppins(fontSize: 24,color: Colors.white,fontWeight: FontWeight.w600),),
