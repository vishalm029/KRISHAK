...
class WeatherState extends State<Weather> {
                   ...
                   crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      ...
                      Padding(
                          ...
                          child: Text('NPK values :',style: GoogleFonts.poppins(color: Colors.white,fontSize: 24,fontWeight: FontWeight.w600),)),
                      Expanded(
                        child: GridView(
                          shrinkWrap: true,
  ...
  String getWeatherIcon(int condition) {
    if (condition < 300) {
      return '.dart_tool/assets/detail/ic_storm_weather.png';
    } else if (condition < 400) {
      return '.dart_tool/assets/detail/ic_rainy_weather.png';
    } else if (condition < 600) {
      return '.dart_tool/assets/detail/ic_rainy_weather.png';
    } else if (condition < 700) {
      return '.dart_tool/assets/detail/ic_snow_weather.png';
    } else if (condition < 800) {
      return '.dart_tool/assets/detail/ic_mostly_cloudy.png';
    } else if (condition == 800) {
      return '.dart_tool/assets/detail/ic_clear_day.png';
    } else if (condition <= 804) {
      return '.dart_tool/assets/detail/ic_cloudy_weather.png';
    } else {
      return '.dart_tool/assets/detail/ic_unknown.png';
    }
  }
