              ...
              children:  [
                const Center(
                  child: CircleAvatar(
                    ...
                    backgroundImage: AssetImage('.dart_tool/assets/detail/kisan_helper.jpg'),
                  ),
                ),
                const SizedBox(
                  height: 10,
          ...
          Padding(padding: const EdgeInsets.fromLTRB(10, 0,0,0),
            child: Row(
              children: [
                ...
                InkWell(
                  onTap:() async { _launchemailURL('krishak@gov.in');setState(() {
                  });},
                  child: const Text('krishak@gov.in',style: TextStyle(decoration: TextDecoration.underline,color: Colors.blue,fontSize: 18),),
                ),
              ],
            ),
          ),
          ...
          Padding(padding: const EdgeInsets.fromLTRB(10, 0,0,0),
            child:Row(
              children: [
                ...
                Text(' KRISHAK Helpline Number: ',style: GoogleFonts.poppins(fontSize:18,color: Colors.black),),
                InkWell(
                  onTap:()=>launch("tel://1800-180-1551"),
                  child: const Text('+91 6393 838433',style: TextStyle(decoration: TextDecoration.underline,color: Colors.blue,fontSize: 18),),
                ),
              ],
            ),
          ),
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                      ...
                      image: const DecorationImage(
                          image: AssetImage('.dart_tool/assets/detail/titans.jpeg')
                      )
                  ),
                ),
              ),
